...
class getEnvironnementRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EnvironnementRepository.php';

        return $container->privates['App\\Repository\\EnvironnementRepository'] = new \App\Repository\EnvironnementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
