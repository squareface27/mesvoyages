...
class __TwigTemplate_e5e20b8ad7fb71030bdd4e628ed9d4bf13ba1bd9a0f82f9745fb933efe101ad9 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div clss=\"container\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["visite"]) {
            ...
            echo "</p>
                            ";
            // line 37
            if ((0 <= twig_compare(twig_get_attribute($this->env, $this->source, $context["visite"], "note", [], "any", false, false, false, 37), 10))) {
                // line 38
